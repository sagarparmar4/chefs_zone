	...
	<div class="container-fluid" style="background-color: rgba(240, 248, 255, 0.86);">
	   <div class="tittle-head">
		...
		<div class="ourhistory">
				<h3>About Japanese Recipes</h3>
				<p>Japanese cuisine is the cuisine of Japan. The traditional cuisine of Japan (washoku) is based on rice
				with miso soup and other dishes,
				with an emphasis on seasonal ingredients. Side dishes often consist of fish, pickled vegetables, and 
			    ...
			    <p>Japan has an indigenous form of sweets called wagashi, which include ingredients such as red bean paste,
				as well as its indigenous rice wine sake.
				Japanese cuisine, particularly sushi, has now become popular throughout the world. As of 2011, Japan overtook
				France in number
				of Michelin starred restaurants and has maintained the title since.</p>
			</div><br>
...
<?php
	...
	{
		$sql = "SELECT * FROM cuisines WHERE category='japanese'";
