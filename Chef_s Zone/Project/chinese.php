	...
	<div class="container-fluid" style="background-color: rgba(240, 248, 255, 0.86);">
	   <div class="tittle-head">
		...
		<div class="ourhistory">
			    ...
			    <p>Chinese society greatly valued gastronomy and developed an extensive study of the subject based on its 
				traditional medical beliefs. Chinese culture initially centered around the North China Plain. The first domesticated
				crops seem to have been the foxtail and broomcorn varieties of millet, while rice was cultivated in the south. 
				By 2000 BC, wheat had arrived from western Asia. 
				However, these grains were typically served as warm noodle soups instead of baked into bread as in Europe.</p>
			</div><br>
...
<?php
	...
	{
		$sql = "SELECT * FROM cuisines WHERE category='chinese'";
