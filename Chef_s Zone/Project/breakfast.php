	...
	<div class="container-fluid" style="background-color: rgba(240, 248, 255, 0.86);">
	   <div class="tittle-head">
		...
		<div class="ourhistory">
				<h3>About Breakfast</h3>
				<p>A Healthy Breakfast Has at Least 5 Grams of Fiber One way to get to those 
				5 grams of fiber is to include a whole grain and/or fruit or vegetables with your breakfast.
				Breakfast is the perfect time to work in a serving or two of whole grains, which along with fiber
				also offer many health-promoting vitamins, minerals, and phytochemicals. Get your grains at breakfast
				by having one of these: Hot oatmeal (or another hot whole-grain cereal). Cold whole-grain cereal. 100%
				whole-wheat bread, small bagel, English muffin, or tortilla Pancakes and waffles made with at least half
				whole-wheat flour (you can also add oats, oat bran, or ground flaxseed for an extra nutrition boost). Muffins
				and cinnamon rolls made with at least half whole-wheat flour (you can also add oats, oat bran, or ground flaxseed).
				</p>
			</div><br>
...
<?php
	...
	{
		$sql = "SELECT * FROM cuisines WHERE sub_category='breakfast'";
