	...
	<div class="container-fluid" style="background-color: rgba(240, 248, 255, 0.86);">
	   <div class="tittle-head">
		...
		<div class="ourhistory">
				<h3>About Dinner</h3>
				<p>Dinner usually refers to the most significant and important meal of the day, which can be the noon or 
				the evening meal. However, the term "dinner" can have many different meanings depending on the culture; 
				it may mean a meal of any size eaten at any time of day.Historically, it referred to the first meal of the day, 
				eaten around noon, and is still sometimes used for a noontime meal, particularly if it is a large or main meal.
...
<?php
	...
	{
		$sql = "SELECT * FROM cuisines WHERE sub_category='dinner'";
