	...
	<div class="container-fluid" style="background-color: rgba(240, 248, 255, 0.86);">
	   <div class="tittle-head">
		...
		<div class="ourhistory">
				<h3>About Indian Recipes</h3>
				<p>Indian cuisine encompasses a wide variety of regional cuisines native to India. Given the range of diversity in soil type, 
				climate, culture, ethnic group and occupations, these cuisines vary significantly from each other and use locally available 
				spices, herbs, vegetables and fruits. Indian food is also heavily influenced by religious and cultural choices and traditions.
			    ...
			    <p>Historical incidents such as foreign invasions, trade relations and colonialism have also played a role in introducing certain foods
				to the country.
				For instance, the potato, a staple of the Indian diet, was brought to India by the Portuguese, who also introduced chillies and breadfruit.
				Indian cuisine has also shaped the history of international relations; the spice trade between India and Europe is often cited by historians
				as the primary
				catalyst for Europe's Age of Discovery.
				Spices were bought from India and traded around Europe and Asia.
				It has also influenced other cuisines across the world, especially those from Southeast Asia, the British Isles, Fiji, and the Caribbean.</p>
			</div><br>
...
<?php
	...
	{
		$sql = "SELECT * FROM cuisines WHERE category='indian'";
		...
		if ($result->num_rows > 0) 
		{
			...
			while($row = $result->fetch_assoc()) 
			{
				...
				*/
				...
				//$uploader='uploads/'.$uploader.'.jpeg';
