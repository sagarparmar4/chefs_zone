	...
	<div class="container-fluid" style="background-color: rgba(240, 248, 255, 0.86);">
	   <div class="tittle-head">
		...
		<div class="ourhistory">
				<h3>About Snacks</h3>
				<p>A snack is a portion of food, often smaller than a regular meal, generally eaten between meals.
				Snacks come in a variety of forms including packaged snack foods and other processed foods, as well as 
				...
				fruit, leftovers, nuts, sandwiches, and the like are used as snacks. The Dagwood sandwich was originally
				the humorous result of a cartoon character's desire for large snacks. With the spread of convenience stores,
				packaged snack foods became a significant business. Snack foods are typically designed to be portable, quick, 
				and satisfying. Processed snack foods, as one form of convenience food, are designed to be less perishable, more durable,
				and more portable than prepared foods. They often contain substantial amounts of sweeteners, preservatives, and appealing
				ingredients such as chocolate, peanuts, and specially-designed flavors (such as flavored potato chips).
				</p>
			</div><br>
...
<?php
	...
	{
		$sql = "SELECT * FROM cuisines WHERE sub_category='snacks'";
