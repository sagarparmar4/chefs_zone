	...
	<div class="container-fluid" style="background-color: rgba(240, 248, 255, 0.86);">
	   <div class="tittle-head">
		...
		<div class="ourhistory">
				...
				over the
				course of many centuries. Regional variations tend to correlate to neighboring states (often sharing the same cultural 
				background and ethnicity on both sides of the border) as well as climate and geography. Northern Thai cuisine shares dishes 
				with Shan State in Burma, northern Laos, and also with Yunnan Province in China, whereas the cuisine of Isan (northeastern
				Thailand) is similar to that of southern Laos, and is also influenced by Khmer cuisine from Cambodia to its south, and by
				Vietnamese cuisine to its east. Southern Thailand, with many dishes that contain liberal amounts of coconut milk and fresh
				turmeric, has that in common with Indian, Malaysian, and Indonesian cuisine.</p>
			</div><br>
			<h2>Thai Recipes</h2>
				<!--start-->				
<!--PHP START-->						
...
include "config.php";	 	 
	...
	{
		$sql = "SELECT * FROM cuisines WHERE category='thai'";
