	...
	<div class="container-fluid" style="background-color: rgba(240, 248, 255, 0.86);">
	   <div class="tittle-head">
		...
		<div class="ourhistory">
				<h3>About Lunch</h3>
				<p>Lunch, the abbreviation for luncheon, is a light meal typically eaten at midday.
				The origin of the words lunch and luncheon relate to a small snack originally eaten at any time of
				the day or night. During the 20th century the meaning gradually narrowed to a small or mid-sized meal
				eaten at midday. Lunch is the second meal of the day after breakfast. The meal varies in size depending on 
				the culture, and significant variations exist in different areas of the world.Meals have become ingrained 
				in each society as being natural and logical. What one society eats may seem extraordinary to another. 
				The same is true of what was eaten long ago in history as food tastes, menu items and meal periods have 
				changed greatly over time. The word supper means bread and soup(from the German word sop- soup or stew over bread).
				Dinner comes from the French word disner which originates from the Latin word disjejeunare which meant to break fast and 
				was a meal eaten in the moring, not the end of the day.
				</p>
			</div><br>
			<h2>Lunch Recipes</h2>
				<!--start-->				
...
<?php
	...
	{
		$sql = "SELECT * FROM cuisines WHERE sub_category='lunch'";
