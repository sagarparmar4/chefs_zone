	...
	<div class="container-fluid" style="background-color: rgba(240, 248, 255, 0.86);">
	   <div class="tittle-head">
		...
		<div class="ourhistory">
			    ...
			    <p>There is not much information about diet or culinary culture before historical time.
				Archeological evidence suggests a hunter-gatherer society that slowly evolved into a more 
				sedentary culture around 7th century BC in the South Western area of the country. This culture, 
				known as Tartessos established trading relations with Phoenician and Greek cities, and used them to develop
				new agricultural techniques and the adoption of new products, such as olive trees and grapes.
				Authors such as Strabo, however, write about aboriginal people using nuts and acorns as staple food.</p>
			</div><br>
			<h2>Spanish Recipes</h2>
				<!--start-->				
<!--PHP START-->						
<?php
	$flag=0;
	...
	{
		$sql = "SELECT * FROM cuisines WHERE category='spanish'";
